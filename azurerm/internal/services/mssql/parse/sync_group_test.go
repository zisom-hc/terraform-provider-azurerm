...
var _ resourceid.Formatter = SyncGroupId{}

func TestSyncGroupIDFormatter(t *testing.T) {
	actual := NewSyncGroupID("12345678-1234-9876-4563-123456789012", "group1", "server1", "database1", "syncGroup1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.Sql/servers/server1/databases/database1/syncGroups/syncGroup1"
	if actual != expected {
		t.Fatalf("Expected %q but got %q", expected, actual)
	}
}

func TestSyncGroupID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
...

		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.Sql/servers/server1/databases/database1/syncGroups/",
			Error: true,
		},

		{
			// valid
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.Sql/servers/server1/databases/database1/syncGroups/syncGroup1",
			Expected: &SyncGroupId{
	...
	for _, v := range testData {
		...
		actual, err := SyncGroupID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
