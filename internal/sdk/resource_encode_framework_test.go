...
func TestResourceEncode_TopLevel(t *testing.T) {
	...
	encodeTestData{
		...
		Expected: map[string]interface{}{
			...
			"map_of_bools": map[string]bool{
				"awesome_feature": true,
			},
			"map_of_numbers": map[string]int64{
				"hello": 1,
				"there": 3,
			},
			"map_of_strings": map[string]string{
				"hello":   "there",
				"salut":   "tous les monde",
				"guten":   "tag",
				"morning": "alvaro",
...
func TestResourceEncode_TopLevelComputed(t *testing.T) {
	...
	encodeTestData{
		...
		Expected: map[string]interface{}{
			...
			"computed_map_of_bools": map[string]bool{
				"hello": true,
				"world": false,
			},
			"computed_map_of_floats": map[string]float64{
				"hello": 1.8965345678,
				"world": 2.0,
			},
			"computed_map_of_ints": map[string]int64{
				"first":  1,
				"second": 2,
				"third":  3,
			},
			"computed_map_of_strings": map[string]string{
				"hello": "world",
				"bingo": "bango",
			},
		},
